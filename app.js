        ...
        if (this.customRulesText && this.customRulesText.trim() !== "") {
            ...
            container.innerHTML = `
                <div class="rule-item">
                    ...
                    <div class="rule-text">
                        <strong>Trả Lời Đúng :</strong> Nhận quyền pháo kích la-ze nhắm thẳng đối thủ <strong id="rule-attack-hp">(-${this.attackDamage} HP)</strong>.
                    </div>
                </div>
                <div class="rule-item">
                    <div class="rule-icon warning-icon">!</div>
                    <div class="rule-text">
                        <strong>Trả Lời Sai (-10 HP):</strong> Tổn hại sinh mạng do lệch lạc tư tưởng.
                    </div>
                </div>
                <div class="rule-item" style="border-color: rgba(239, 68, 68, 0.2);">
                    <div class="rule-icon info-icon" style="background: #ef4444; color: #fff;">⌚</div>
                    <div class="rule-text">
                ...
                <div class="rule-item">
                    ...
                    <div class="rule-text">
                        <strong>Thăng Cấp :</strong> Tích điểm Đấu Tranh để tiến hóa giai cấp, kích hoạt <strong>Lá chắn Tư bản & Chí mạng!</strong>
                    </div>
                </div>
            `;
        }
